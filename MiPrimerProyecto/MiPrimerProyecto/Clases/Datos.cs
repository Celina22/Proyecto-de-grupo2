...
namespace MiPrimerProyecto.Clases
{
    class Datos
    {
        ...
        private string cadenaConexion = @"Data Source=DESKTOP-SFPMQMT\SQLEXPRESS;Initial Catalog=Bugstracker;Persist Security Info=True;User ID=sa;Password=Blaziken99";
